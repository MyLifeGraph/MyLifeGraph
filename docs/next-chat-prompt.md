...
This prompt starts a critical whole-product review of the current Today V2,
Planner, Study Setup, Deadline Planner, and controlled Coach checkout. The
complete context and review checklist are in `docs/product-review-handoff.md`.
...
the app mentally and through tests from revision-safe Setup and optional Study
Setup through Today V2, Quick actions, Planner, Focus, Deadline preparation,
recovery, Insights, Weekly Review, Inbox, Calendar, Coach, and account controls.
Review calculation, recovery reservations, semester bounds, calendar isolation,
focus credit, retry identity, RLS, capability truth, small screens, large text,
and ambiguous failures. Check whether any LLM addition would improve the
product without making calculation or mutation authority opaque. Prefer small
compatible fixes over a broad redesign.
