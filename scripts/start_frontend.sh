...
if [[ -f "$ROOT_DIR/.env" ]]; then
  override_names=(
    ...
    AI_SERVICE_BASE_URL SPEECH_SERVICE_BASE_URL MODE SUPABASE_URL SUPABASE_PUBLISHABLE_KEY
...
common_defines=(
  ...
  "--dart-define=SPEECH_SERVICE_BASE_URL=${SPEECH_SERVICE_BASE_URL:-}"
  ...
  "--dart-define=PILOT_CONTACT_EMAIL=$PILOT_CONTACT_EMAIL"
)
